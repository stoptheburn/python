...
####	5. If the DateTimeOriginal metadata is unavailable, lastmodified timestamp is used 
####	   to move the file to a directory structured as YYYY/YYYY-MM/YYYY-MM-mtime
